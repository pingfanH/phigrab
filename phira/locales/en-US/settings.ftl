...
item-dghub-project = Project Phigrab
item-dghub-link = DGHub Link
item-dghub-qq = QQ Group 229380808
item-dghub-note = Notes
item-dghub-note-sub = Make sure this device and the device running DGHub are on the same LAN (Wi-Fi / mobile data), check firewall settings, and join the QQ group for updates or help.
...
item-dghub-status = DGHub Status
item-dghub-status-off = Not connected
item-dghub-status-connecting = Connecting...
item-dghub-status-connected = Connected
item-dghub-reconnect = Reconnect
item-dghub-source = Config Source
item-dghub-source-sub = After enabling it, scroll down to see the configuration.
item-dghub-source-dghub = DGHub Side
item-dghub-source-phira = Phira Side
item-dghub-strength = Strength (%)
item-dghub-duration = Duration (s)
...
item-dghub-clear-strength-on-pause = Clear Strength on Pause
item-dghub-clear-strength-on-pause-sub = Reset DGHub channel strength to 0 when paused.
dghub = External
