...
item-dghub = 外部連接
item-dghub-sub = 連接到 DGHub / dglab 外部服務
item-dghub-author = 製作 pingfanh
item-dghub-project = 項目名 Phigrab
item-dghub-link = DGHub 連結
item-dghub-qq = QQ群 229380808
item-dghub-note = 說明
item-dghub-note-sub = 確保和開啟 DGHub 的設備在同一區域網路下（Wi-Fi、行動數據），以及檢查防火牆等設定，取得更新/諮詢問題加 QQ 群
item-dghub-open-github = GitHub
item-dghub-open-browser = 瀏覽器
dghub = 外部連接
...
item-dghub-source = 配置來源
item-dghub-source-sub = 開啟後下滑即可看到配置
item-dghub-source-dghub = DGHub 端配置
item-dghub-source-phira = Phira 端配置
